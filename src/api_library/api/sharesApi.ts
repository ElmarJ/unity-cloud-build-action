...
export class SharesApi {
     ...
     */
    public async getShareMetadata (shareid: string, include?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/shares/{shareid}'
        ...
        if (shareid === null || shareid === undefined) {
            throw new Error('Required parameter shareid was null or undefined when calling getShareMetadata.');
        }
