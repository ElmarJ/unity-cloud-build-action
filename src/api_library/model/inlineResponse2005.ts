...
export class InlineResponse2005 {
    'hookType': InlineResponse2005.HookTypeEnum;
    'events'?: Array<InlineResponse2005.EventsEnum>;
    'config': object;
    'active'?: boolean;
    'id'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "hookType",
            "baseName": "hookType",
            "type": "InlineResponse2005.HookTypeEnum"
        },
        {
            "name": "events",
            "baseName": "events",
            "type": "Array<InlineResponse2005.EventsEnum>"
        },
        {
            "name": "config",
            "baseName": "config",
...
export namespace InlineResponse2005 {
    ...
    export enum EventsEnum {
        ProjectBuildQueued = <any> 'ProjectBuildQueued',
        ProjectBuildStarted = <any> 'ProjectBuildStarted',
        ProjectBuildRestarted = <any> 'ProjectBuildRestarted',
        ProjectBuildSuccess = <any> 'ProjectBuildSuccess',
        ProjectBuildFailure = <any> 'ProjectBuildFailure',
        ProjectBuildCanceled = <any> 'ProjectBuildCanceled',
        ProjectBuildUpload = <any> 'ProjectBuildUpload'
    }
}
