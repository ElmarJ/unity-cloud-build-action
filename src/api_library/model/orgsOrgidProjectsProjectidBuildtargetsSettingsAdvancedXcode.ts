...
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedXcode {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "useArchiveAndExport",
            "baseName": "useArchiveAndExport",
            "type": "boolean"
        },
        {
            "name": "customFastlaneConfigPath",
            "baseName": "customFastlaneConfigPath",
            "type": "string"
        },
        {
            "name": "shouldNotarize",
            "baseName": "shouldNotarize",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedXcode.attributeTypeMap;
    }
}
