...
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAssetBundles {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "buildAssetBundleOptions",
            "type": "string"
        },
        {
            "name": "copyToStreamingAssets",
            "baseName": "copyToStreamingAssets",
            "type": "boolean"
        },
        {
            "name": "copyBundlePatterns",
            "baseName": "copyBundlePatterns",
            "type": "Array<string>"
        }    ];

    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAssetBundles.attributeTypeMap;
    }
}
