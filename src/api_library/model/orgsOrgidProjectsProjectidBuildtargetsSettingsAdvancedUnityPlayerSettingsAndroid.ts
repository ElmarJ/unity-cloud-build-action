...
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityPlayerSettingsAndroid {
    /**
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "baseName": "useAPKExpansionFiles",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityPlayerSettingsAndroid.attributeTypeMap;
    }
}
