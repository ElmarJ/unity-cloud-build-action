...
export class OrgsOrgidProjectsProjectidBuildtargetsFailureDetails {
    'label'?: string;
    ...
    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsFailureDetails.attributeTypeMap;
    }
}
