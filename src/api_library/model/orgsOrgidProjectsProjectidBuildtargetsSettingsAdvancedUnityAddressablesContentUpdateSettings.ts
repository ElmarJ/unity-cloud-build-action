...
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAddressablesContentUpdateSettings {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "contentStatePath",
            "baseName": "contentStatePath",
            "type": "string"
        },
        {
            "name": "linkedTargetId",
            "baseName": "linkedTargetId",
            "type": "string"
        }    ];

    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAddressablesContentUpdateSettings.attributeTypeMap;
    }
}
