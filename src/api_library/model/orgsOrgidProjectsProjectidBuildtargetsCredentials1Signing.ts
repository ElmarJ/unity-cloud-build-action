...
export class OrgsOrgidProjectsProjectidBuildtargetsCredentials1Signing {
    'credentialid'?: string;
    ...
    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsCredentials1Signing.attributeTypeMap;
    }
}
