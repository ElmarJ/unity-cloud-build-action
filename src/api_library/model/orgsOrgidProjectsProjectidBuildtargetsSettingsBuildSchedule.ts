...
*/
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsBuildSchedule {
    'isEnabled'?: boolean;
    'date'?: Date;
    'repeatCycle'?: OrgsOrgidProjectsProjectidBuildtargetsSettingsBuildSchedule.RepeatCycleEnum;
    'cleanBuild'?: boolean;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "repeatCycle",
            "baseName": "repeatCycle",
            "type": "OrgsOrgidProjectsProjectidBuildtargetsSettingsBuildSchedule.RepeatCycleEnum"
        },
        {
            "name": "cleanBuild",
            "baseName": "cleanBuild",
    ...
    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsBuildSchedule.attributeTypeMap;
    }
}

export namespace OrgsOrgidProjectsProjectidBuildtargetsSettingsBuildSchedule {
    export enum RepeatCycleEnum {
        None = <any> 'none',
        Once = <any> 'once',
        Daily = <any> 'daily',
        Weekly = <any> 'weekly',
