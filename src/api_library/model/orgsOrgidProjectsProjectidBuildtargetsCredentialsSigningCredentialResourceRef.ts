...
export class OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRef {
    'platform'?: OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRef.PlatformEnum;
    'label'?: string;
    'credentialid'?: string;
    'created'?: string;
    'lastMod'?: string;
    'certificate'?: OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRefCertificate;
    'provisioningProfile'?: OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "platform",
            "baseName": "platform",
            "type": "OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRef.PlatformEnum"
        },
        {
            "name": "label",
            "baseName": "label",
    ...
    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRef.attributeTypeMap;
    }
}

export namespace OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRef {
