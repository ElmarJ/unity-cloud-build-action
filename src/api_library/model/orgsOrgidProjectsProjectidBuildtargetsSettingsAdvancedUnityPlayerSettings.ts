...
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityPlayerSettings {
    ...
    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityPlayerSettings.attributeTypeMap;
    }
}
