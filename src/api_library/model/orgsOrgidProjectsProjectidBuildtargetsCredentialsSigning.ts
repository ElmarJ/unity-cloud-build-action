...
export class OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigning {
    'credentialid'?: string;
    'credentialResourceRef'?: OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRef;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "credentialResourceRef",
            "baseName": "credentialResourceRef",
            "type": "OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigningCredentialResourceRef"
        }    ];

    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsCredentialsSigning.attributeTypeMap;
    }
}
