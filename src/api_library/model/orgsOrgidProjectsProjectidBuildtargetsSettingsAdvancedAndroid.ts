...
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedAndroid {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "buildAppBundle",
            "baseName": "buildAppBundle",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedAndroid.attributeTypeMap;
    }
}
