...
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAddressables {
    /**
    ...
    */
    ...
    'contentUpdateSettings'?: OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAddressablesContentUpdateSettings;

    static discriminator: string | undefined = undefined;

    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "buildAddressables",
            "baseName": "buildAddressables",
            "type": "boolean"
        },
        {
            "name": "contentUpdate",
        ...
        {
            "name": "failedAddressablesFailsBuild",
            "baseName": "failedAddressablesFailsBuild",
            "type": "boolean"
        },
        {
            "name": "contentUpdateSettings",
            "baseName": "contentUpdateSettings",
            "type": "OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAddressablesContentUpdateSettings"
        }    ];

    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityAddressables.attributeTypeMap;
    }
}
