...
export class InlineResponse20011 {
    ...
    'duration': number;
    'name': string;
    'messages'?: Array<OrgsOrgidProjectsProjectidBuildtargetsBuildtargetidBuildsNumberStepsMessages>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "messages",
            "baseName": "messages",
            "type": "Array<OrgsOrgidProjectsProjectidBuildtargetsBuildtargetidBuildsNumberStepsMessages>"
        }    ];
