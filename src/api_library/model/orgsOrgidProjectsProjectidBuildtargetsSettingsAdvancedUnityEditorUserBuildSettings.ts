...
export class OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityEditorUserBuildSettings {
    /**
    * which android build system to build with (android only, supported in Unity 5.5+)
    */
    'androidBuildSystem'?: OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityEditorUserBuildSettings.AndroidBuildSystemEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "baseName": "androidBuildSystem",
            "type": "OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityEditorUserBuildSettings.AndroidBuildSystemEnum"
        }    ];

    static getAttributeTypeMap() {
        return OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityEditorUserBuildSettings.attributeTypeMap;
    }
}

export namespace OrgsOrgidProjectsProjectidBuildtargetsSettingsAdvancedUnityEditorUserBuildSettings {
    export enum AndroidBuildSystemEnum {
